...
async function setting() {
  ...
  const HackathonAttestationAddress =
    "0xb76BdAAf88679FaCb2108179f146dc77bD5CaFDb";
  ...
  // );
  const projectId = ethers.utils.formatBytes32String("test");
  ...
  // };
  // console.log(attestForDonation);
  // console.log(
  //   "Account before balance:",
  //   await ethers.provider.getBalance(donator)
  // );
